...
class RayPPOTrainer:
    ...
    def _maybe_log_val_generations(
        self, inputs: List[str], outputs: List[str], labels: List[str], refers: List[str], scores: List[float]
    ) -> None:
        ...
        samples = list(zip(inputs, outputs, labels, refers,  scores))
    ...
    def _validate(self) -> Dict[str, Any]:
        ...
        sample_inputs, sample_outputs, sample_labels, sample_refers, sample_scores = [], [], [], [], []
        ...
        for batch_dict in self.val_dataloader:
            ...
            sample_refers.extend(test_batch.non_tensor_batch["refer_message"].tolist())
        ...
        self._maybe_log_val_generations(sample_inputs, sample_outputs, sample_labels, sample_refers, sample_scores)
